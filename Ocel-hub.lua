-- =============================================================================
-- DOORS LOCAL MEGA HUB v14.0 (FULL BYPASS EDITION)
-- =============================================================================
...
-- Флаги байпасов
_G.AntiA90Enabled = false
_G.AntiScreechEnabled = false
_G.AntiSnareEnabled = false
_G.AntiTimothyEnabled = false
_G.AntiGiggleEnabled = false

-- Находим папку с ремоутами Doors в ReplicatedStorage
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Remotes = ReplicatedStorage:FindFirstChild("Remotes") or ReplicatedStorage:FindFirstChild("EntityInfo")
