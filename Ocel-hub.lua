-- =============================================================================
-- DOORS LOCAL MEGA HUB v12.3 (FULL RESTORE + DYNAMIC DISTANCE ESP)
-- =============================================================================
...
-- =============================================================================
-- 2. ESP ENGINE С ДИНАМИЧЕСКОЙ ДИСТАНЦИЕЙ
-- =============================================================================
...
CustomNotify("SYSTEM", "Ocel-hub v12.3 успешно запущен!")local function ApplyFullbright(enabled)
    local Lighting = game:GetService("Lighting")
    if enabled then
        local c = Colors.Fullbright
        Lighting.Ambient = c
